...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      {/* create two column using tailwind classes, and add 3 buttons to each with onclick method */}
      ...
      <div className="text-center">
        ...
        <div className="flex flex-col">
          <div className="flex-1">
            <div className="text-md">{player1.name} {player1.action}</div>
            <div className="flex flex-col">
              <div className="flex-1">
          ...
          <div className="flex-1">
            <div className="text-md">{player2.name} {player2.action}</div>
            <div className="flex flex-col">
              <div className="flex-1">
                <div className="text-md">{result.winner}</div>
                <div className="text-md">{result.loser}</div>
